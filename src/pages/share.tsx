...
type Data = { dog: DogProfile; mode: "basic" | "care" | "lost"; canEdit: boolean; links: Partial<Record<DogPublicLinkType, string>>; entries: GuestbookEntry[]; reports: FoundLocationReport[] };
...
async function loadShare(slug: string): Promise<Data | null> {
  ...
  return { dog, mode: publicLink.type === "LOST" ? "lost" : publicLink.type === "CARE" ? "care" : "basic", canEdit, links, entries, reports };
}
